...
abstract class AppLocalizations {
  ...
  /// Onboarding rounds page title
  ///
  /// In en, this message translates to:
  /// **'3 Rounds'**
  String get onboardingRoundsTitle;

  /// Onboarding rounds description
  ///
  /// In en, this message translates to:
  /// **'Each round gets harder: describe freely, then one word only, then mime!'**
  ...
  ///
  /// In en, this message translates to:
  /// **'Form your teams, pick your categories, and let the fun begin!'**
  String get onboardingReadyDescription;

  /// Pass penalty section title
  ///
  /// In en, this message translates to:
  /// **'Pass Penalty'**
  String get passPenalty;
